      ...
      <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 mb-4">
            O Que Nossos <span className="text-primary-700">Clientes Dizem</span>
          </h2>
          <p className="text-base sm:text-lg text-gray-600 max-w-2xl mx-auto mb-8">
            Confira os depoimentos reais de quem já confiou na TELAR SOROCABA
          </p>

          <div className="inline-flex flex-col sm:flex-row items-center bg-white rounded-2xl shadow-lg px-6 sm:px-8 py-6 sm:py-8 border-2 border-primary-100 max-w-full">
            ...
            <div className="sm:border-l-2 border-gray-200 sm:pl-6 text-center sm:text-left">
              <div className="flex flex-col sm:flex-row items-center sm:items-baseline mb-2">
              ...
              <Card className="h-full border-2 border-gray-100 hover:border-primary-200 hover:shadow-lg transition-all duration-300">
                <CardContent className="p-6">
                  ...
                  <div className="flex items-center pt-4 border-t border-gray-100">
                    <div className="w-10 h-10 sm:w-12 sm:h-12 bg-gradient-to-br from-primary-500 to-secondary-500 rounded-full flex items-center justify-center text-white font-bold mr-3">
                      {review.avatar}
                    </div>
        ...
        >
          <a
            href="https://www.google.com/search?q=telar+sorocaba"
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center bg-white border-2 border-primary-600 text-primary-700 px-6 sm:px-8 py-3 sm:py-4 rounded-lg font-bold hover:bg-primary-50 transition-colors text-sm sm:text-base"
          >
