...
export default function Hero() {
  return (
    <section
      id="inicio"
      className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-primary-50 via-white to-secondary-50 pt-20 px-4"
    >
      ...
      <div className="container mx-auto relative z-10">
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              ...
              <a href="#trabalhos" className="flex-1">
                <Button size="lg" variant="outline" className="w-full border-2 border-primary-600 text-primary-700 hover:bg-primary-50">
          ...
          >
            ...
            <div className="absolute -top-4 -right-4 w-24 h-24 bg-secondary-500 rounded-full opacity-20 blur-2xl" />
            <div className="absolute -bottom-4 -left-4 w-32 h-32 bg-primary-500 rounded-full opacity-20 blur-2xl" />
          </motion.div>
        </div>
      </div>
